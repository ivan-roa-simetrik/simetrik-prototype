...
export const PromptInputActionAddAttachments = ({
  ...
  const handleSelect = useCallback(
    // biome-ignore lint: Base UI's DropdownMenuItem onSelect event type vs. native Event
    (e: any) => {
      e.preventDefault();
...
export const PromptInputSubmit = ({
  ...
  const handleClick = useCallback(
    // biome-ignore lint: Base UI's Button onClick event type vs. native MouseEvent
    (e: any) => {
